...
function _makeMeshCanvas(w, h) {
  ...
  const _yellowInt = parseFloat(document.getElementById('inp-yellow-intensity')?.value || 0) / 100;
  const _whiteInt  = parseFloat(document.getElementById('inp-white-intensity')?.value || 0) / 100;
